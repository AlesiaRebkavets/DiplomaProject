...
public class LoginPage : BasePage
{
    ...
    private MyWebElement _requiredErrorForUsernameTextBox =
        new MyWebElement(By.XPath("//*[*[@name='username']]/../*[text()='Required']"));

    private MyWebElement _requiredErrorForPasswordTextBox =
        new MyWebElement(By.XPath("//*[*[@name='password']]/../*[text()='Required']"));

    private MyWebElement _invalidCredentialsErrorMessage =
        new MyWebElement(By.XPath("//*[text()='Invalid credentials']"));
    ...
    public bool IsRequiredErrorForUsernameTextBoxDisplayed => _requiredErrorForUsernameTextBox.Displayed;

    // returns 'true' if the 'Required' error message is displayed next to the 'Password' text box
    public bool IsRequiredErrorForPasswordTextBoxDisplayed => _requiredErrorForPasswordTextBox.Displayed;

    // returns 'true' if 'Invalid Credentials' error message is displayed
    public bool IsInvalidCredentialsErrorMessageDisplayed => _invalidCredentialsErrorMessage.Displayed;
}