...
public class AdminPage: BasePage
{
    ...
    private MyWebElement _userRoleDropdown = new MyWebElement(By.XPath("//*[text()='User Role']/../following-sibling::*"));
    ...
    private MyWebElement _enabledStatusDropdownOption = new MyWebElement(By.XPath("//*[@role='listbox']//*[text()='Enabled']"));
    ...
    private MyWebElement _passwordInputField = new MyWebElement(By.XPath("//*[text()='Password']/../following-sibling::*/*[@type='password']"));

    private MyWebElement _confirmPasswordInputField = new MyWebElement(By.XPath("//*[text()='Confirm Password']/../following-sibling::*/*[@type='password']"));

    private MyWebElement _usernameInputField = new MyWebElement(By.XPath("//*[text()='Username']/../following-sibling::*/*"));
    ...
    private MyWebElement _requiredErrorMessageOfStatusInputField = new MyWebElement(By.XPath("//*[text()='Status']/../following-sibling::*/../*[text()='Required']"));
    
    private MyWebElement _requiredErrorMessageOfPasswordInputField = new MyWebElement(By.XPath("//*[text()='Password']/../following-sibling::*/../*[text()='Required']"));
    
    private MyWebElement _requiredErrorMessageOfEmployeeNameInputField = new MyWebElement(By.XPath("//*[text()='Employee Name']/../following-sibling::*/../*[text()='Required']"));
    
    private MyWebElement _requiredErrorMessageOfUserNameInputField = new MyWebElement(By.XPath("//*[text()='Username']/../following-sibling::*/../*[text()='Required']"));
    
    private MyWebElement _requiredErrorMessageOfConfirmPasswordInputField = new MyWebElement(By.XPath("//*[text()='Confirm Password']/../following-sibling::*/../*[text()='Required']"));
